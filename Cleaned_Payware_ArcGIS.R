...
#First run the functions in the function r file "Cleaned_Payware_ArcGIS_functions.R"
#Then connect
source("Cleaned_Payware_ArcGIS_functions.R")
...
#eg. Kanana_path <- "C:/Users/SamSmith/Folder1/Folder2/Kanana_predictions.dbf"

Kanana_path <- "C:/.../Kanana_predictions.dbf"
...
# improve predictions with bird % predictions
...
#####################################################
### DISSOLVE POLYGONS TO FURTHER PROCESS VIA SIZE ###
#####################################################

# load dbfs according to file location on your computer
Kanana_dissolve_path <- "C:/.../Kanana_predictions_dissolve.dbf"
...
#eg. eulimbah_path <- "C:/Users/SamSmith/Folder/Folder2/eulimbah_predictions.dbf"
eulimbah_path <- "C:/.../eulimbah_predictions.dbf"
...
eulimbah_dissolve_path <- "C:/Users/.../eulimbah_predictions_dissolve.dbf"
